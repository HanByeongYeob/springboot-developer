...
public class BlogApiController {
    ...
    // HTTP 메서드가 POST일 떄 전달받은 URL과 동일하면 메서드로 메핑
    ...
    public ResponseEntity<Article> updataArticle(@PathVariable long id, @RequestBody UpdateArticleRequest requeset){
        Article updateArticle = blogService.update(id, requeset);
